...
class Car:
	...
	car_sprites = ("red", "green", "grey", "yellow", "violet")
...
def run_generation(genomes, config):
	...
	while True:
		...
		label = heading_font.render("Generation: " + str(generation), True, (73,168,70))
		label_rect = label.get_rect()
		label_rect.center = (width / 1.5, 300)
		screen.blit(label, label_rect)

		label = font.render("Cars left: " + str(cars_left), True, (51,59,70))
		label_rect = label.get_rect()
